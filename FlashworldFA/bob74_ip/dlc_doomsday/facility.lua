                ...
                Enable = function(state)
                    ...
                    if (state) then
                        if (handle == 0) then
                            ...
                            local privacyGlass = CreateObjectNoOffset(DoomsdayFacility.PrivacyGlass.controlMdelHash, DoomsdayFacility.PrivacyGlass.Bedroom.Control.position.x, DoomsdayFacility.PrivacyGlass.Bedroom.Control.position.y, DoomsdayFacility.PrivacyGlass.Bedroom.Control.position.z, false, false, false)
