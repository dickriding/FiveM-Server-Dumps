local function HandleControls()
    if Wheel.PedIsSitting then
        if Config.Enable3dText then
            ...
            exports.gamemode:displayHelpText(Config.Text.WHEEL_GET_OFF)
        end
        ...
        if #(Wheel.PlatformCoords - playerPos) < 1.2 then
            ...
            if cabinFull then
                if Config.Enable3dText then
                    ...
                    exports.gamemode:displayHelpText(Config.Text.WHEEL_CABIN_FULL)
                end
            else
                if Config.Enable3dText then
                    local x, y, z = table.unpack(Wheel.PlatformCoords)
                    ...
                    exports.gamemode:displayHelpText(Config.Text.WHEEL_GET_ON)
                end
