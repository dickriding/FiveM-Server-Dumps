    ...
    if Freefall.PedIsSitting then
        if Freefall.InProgress then
            if Config.Enable3dText then
                ...
                exports.gamemode:displayHelpText(Config.Text.FREEFALL_GET_OFF)
            end
        else
            if Config.Enable3dText then
                ...
                exports.gamemode:displayHelpText(Config.Text.FREEFALL_START)
            end
        end
        ...
        if #(Freefall.PlatformCoords - playerPos) < 1.5 then
            ...
            if full then
                if Config.Enable3dText then
                    ...
                    exports.gamemode:displayHelpText(Config.Text.FREEFALL_FULL)
                end
            else
                if Config.Enable3dText then
                    local x, y, z = table.unpack(Freefall.PlatformCoords)
                    ...
                    exports.gamemode:displayHelpText(Config.Text.FREEFALL_GET_ON)
                end
