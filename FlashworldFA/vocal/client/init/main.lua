...
RegisterCommand(
	"+radiovoldown",
	function()
		local new = tonumber(volumes["radio"]) - 0.1
		if new < 0 then
			new = 0
		end
		setVolume(new * 100, "radio")
	end,
	false
)
RegisterKeyMapping("+radiovoldown", "Augmenter volume radio", "keyboard", "")
...
RegisterKeyMapping("+radiovolup", "Baisser volume radio", "keyboard", "")
