        ...
        if closestRack then
            ...
            if dist < maxDist then
                ...
                if HasPoolCueInHand then
                    exports.gamemode:displayHelpText('~' .. WithoutObfuscation(Config.Keys.ENTER.label) .. '~' .. Config.Text.HINT_RETURN_CUE)
                else
                    exports.gamemode:displayHelpText('~' .. WithoutObfuscation(Config.Keys.ENTER.label) .. '~ ' .. Config.Text.HINT_TAKE_CUE)
                end
