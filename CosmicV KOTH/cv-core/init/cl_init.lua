...
local function removeWeaponDrops()
...
Citizen.CreateThread(function()
    ...
    NetworkResurrectLocalPlayer(0,0,0,0,false,false)
    SetPedConfigFlag(PlayerPedId(), 438, true)
    StartAudioScene("CHARACTER_CHANGE_IN_SKY_SCENE")
    SetAudioFlag("PoliceScannerDisabled", true)

    TriggerServerEvent("SV_cv-core:playerInitialized")
    TriggerEvent("CL_cv-core:playerInitialized")
    ...
    CL_GAME.players[tostring(serverId)] = CL_PLAYER.new(serverId)
    ...
    while true do
        ...
        NetworkOverrideClockTime(GlobalState.hour, 0, 0)
        SetWeatherTypeNowPersist(GlobalState.weather)
        SetRainLevel(0.0)
    end
end)

RegisterNetEvent('cv-core:fadeIn')
AddEventHandler('cv-core:fadeIn', DoScreenFadeIn)

RegisterNetEvent('cv-core:fadeOut')
AddEventHandler('cv-core:fadeOut', DoScreenFadeOut)