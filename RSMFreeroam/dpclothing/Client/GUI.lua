...
local function DrawButton(b)
	local x,y = GetCursor()
	local CursorDistance = Distance(b.x + 0.005, b.y + 0.025, x, y)
	local hovering = CursorDistance < 0.025

	local B = Config.GUI.ButtonColor
	local Rot = b.Rotate or 0.0

	if b.Shadow then
		DrawSprite("dp_clothing", "circle", b.x, b.y, b.Size.Circle.x/0.80, b.Size.Circle.y/0.80, Rot, hovering and 105 or b.Colour.r, hovering and 105 or b.Colour.g, hovering and 255 or b.Colour.b, b.Alpha)
	end

	DrawSprite("dp_clothing", b.Sprite, b.x, b.y, b.Size.Sprite.x/0.68, b.Size.Sprite.y/0.68, b.Rotation, hovering and 105 or 255, hovering and 105 or 255, 255, b.Alpha)
