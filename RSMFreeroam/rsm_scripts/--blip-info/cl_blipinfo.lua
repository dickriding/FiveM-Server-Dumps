...
CreateThread(function()
    ...
    exports("ResetBlipInfo", ResetBlipInfo)
    exports("SetBlipInfoTitle", SetBlipInfoTitle)
    exports("SetBlipInfoImage", SetBlipInfoImage)
    exports("SetBlipInfoEconomy", SetBlipInfoEconomy)
    exports("SetBlipInfo", SetBlipInfo)
    exports("AddBlipInfoText", AddBlipInfoText)
    exports("AddBlipInfoName", AddBlipInfoName)
    exports("AddBlipInfoHeader", AddBlipInfoHeader)
    exports("AddBlipInfoIcon", AddBlipInfoIcon)
end)