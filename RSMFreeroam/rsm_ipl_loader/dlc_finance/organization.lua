...
Citizen.CreateThread(function()
    ...
    AddEventHandler("interior:enter", function(interiorId)
        if interiorId == FinanceOffice1.currentInteriorId or interiorId == FinanceOffice2.currentInteriorId or interiorId == FinanceOffice3.currentInteriorId or interiorId == FinanceOffice4.currentInteriorId then   
            inInterior = true
