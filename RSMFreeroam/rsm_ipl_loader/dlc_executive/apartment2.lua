...
ExecApartment2 = {
    ...
    Style = {
        ...
        Set = function(style, refresh)
            if (IsTable(style)) then
                ...
                for name, data in pairs(ExecApartment2.Style.Theme) do
                    if data.interiorId == style.interiorId then
                        currentTheme = name
                    end
                end
            end
        ...
        Get = function()
            return currentTheme, ExecApartment2.Style.Theme[currentTheme]
        end,
        Clear = function()
    ...
    LoadDefault = function()
        ExecApartment2.Style.Set(ExecApartment2.Style.Theme.modern, true)
