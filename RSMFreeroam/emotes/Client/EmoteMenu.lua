...
local FaceTable = {}
local ShareTable = {}
FavoriteEmote = GetResourceKvpString("favorite_emote")
...
function AddEmoteMenu(menu)
    ...
    local custommenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['customemotes'], "", "", Menuthing, Menuthing)
    ...
    table.insert(EmoteTable, Config.Languages[lang]['danceemotes'])
    table.insert(EmoteTable, Config.Languages[lang]['customemotes'])
    ...
    for a,b in pairsByKeys(DP.Custom) do
      x,y,z = table.unpack(b)
      customitem = NativeUI.CreateItem(z, "/e ("..a..")")
      custommenu:AddItem(customitem)
      table.insert(CustomTable, a)
    end
    ...
    if not Config.SqlKeybinding then
      favmenu.OnItemSelect = function(sender, item, index)
        ...
        if Config.FavKeybindEnabled then
          ...
          SetResourceKvp("favorite_emote", FavoriteEmote)
    ...
    custommenu.OnItemSelect = function(sender, item, index)
      EmoteMenuStart(CustomTable[index], "custom")
    end
